...
<div class="container-fluid">
    <header class="text-center">
      <h1 class="display-4">Reject Order</h1>
        ...
        <div class="card rounded shadow border-0">
          <div class="card-body p-5 bg-white rounded">
              ...
              <table id="example" style="width:100%" class="table table-striped text-center">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="/admin/pendingorder/{{ $order['order_id'] }}"><img src="https://img.icons8.com/metro/344/checkmark.png" width="25px"></a>
                    ...
                    @endforeach
                    @else
                    <td colspan="8">No Reject Order Found</td>
                    @endif
                </tbody>
              </table>
            </div>
            <div class="table-responsive">
                <ul class="pagination">
                    @if($page >= 2)
                    <li class="page-item"><a class="page-link" href="/admin/rejectorderlist/{{ $page-1 }}">Previous</a></li>
                    @endif
                    @for($i = 1; $i <= $number_of_page; $i++)
                    @if($page == $i)
                    <li class="page-item active"><a class="page-link" href="/admin/rejectorderlist/{{ $i }}">{{$i}}</a></li>
                    @continue
                    @endif
                    <li class="page-item"><a class="page-link" href="/admin/rejectorderlist/{{ $i }}">{{$i}}</a></li>
                    @endfor
                    @if($page < $number_of_page)
                    <li class="page-item"><a class="page-link" href="/admin/rejectorderlist/{{ $page+1 }}">Next</a></li>
                    @endif
                </ul>
            </div>
          </div>
